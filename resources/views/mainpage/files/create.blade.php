...
@section('container')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Create new file</h1>
    </div>

    <div class="col-lg-8">
        <form method="post" action="/mainpage/files" class="mb-5" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="slug" value="{{ $slug }}">
            <div class="mb-3">
                <label for="document_name" class="form-label">Document title</label>
                <input type="text" class="form-control @error('document_name') is-invalid @enderror" id="document_name" name="document_name" required autofocus value="{{ old('document_name') }}">
                @error('document_name')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('reference_no') is-invalid @enderror" id="reference_no" name="reference_no" required autofocus value="{{ old('reference_no') }}">
                @error('reference_no')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>      
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('version') is-invalid @enderror" id="version" name="version" required autofocus value="{{ old('version') }}">
                @error('version')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>      
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('release_date') is-invalid @enderror" id="datepicker" name="release_date" required autofocus value="{{ old('release_date') }}">
                @error('release_date')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>      
